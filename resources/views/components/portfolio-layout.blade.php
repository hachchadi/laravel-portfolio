...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <title>{{ $title ?? config('app.name', 'Laravel Portfolio') }}</title>
        <meta name="description" content="{{ $description ?? 'Professional portfolio showcasing skills, projects, and experience' }}">
    ...
    <body class="font-sans antialiased bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
          ...
          @scroll-to-section.window="scrollToSection($event.detail.section)">
